...
public class DrivingEvent implements Serializable {
	...
	public double m_loc_lon;
	public double m_loc_lat;
	private String username;

	public DrivingEvent() {
	}
    
	public DrivingEvent(String eventid, long tripid, int m_event_type,
			Timestamp m_start_time, Timestamp m_end_time, double m_loc_lon,double m_loc_lat) {
	...
	public DrivingEvent(long tripid, int m_event_type,
			Timestamp m_start_time, Timestamp m_end_time, double m_loc_lon,
			double m_loc_lat, String username) {
		super();
		this.tripid = tripid;
