...
public class BNavigatorActivity extends Activity{
    ...
    /*
    private IRGInfoListener mIRGInfoListener = new IRGInfoListener(){
        public void onHUDUpdate(android.os.Message msg)
        {

        }

        public void onRasterExpandMapUpdate(android.os.Message message)
        {

        }

        public void onRemainDistTimeUpdate(android.os.Message message)
        {

        }

        public void onSimpleGuideInfoShow(android.os.Message message)
        {

        }

        public void onSimpleGuideInfoHide(android.os.Message message)
        {

        }

        public void onDirectBoardHide(android.os.Message message)
        {

        }

        public void onVectorExpandMapShow(android.os.Message message)
        {

        }

        public void onAssistInfoUpdate(android.os.Message message)
        {

        }

        public void onDirectBoardShow(android.os.Message message)
        {

        }

        public void onAssistInfoShow(android.os.Message message)
        {

        }

        public void onVectorExpandMapUpdate(android.os.Message message)
        {

        }

        public void onRasterExpandMapShow(android.os.Message message)
        {

        }

        public void onRasterExpandMapHide(android.os.Message message)
        {

        }

        public void onDirectBoardUpdate(android.os.Message message)
        {

        }

        public void onSimpleGuideInfoUpdate(android.os.Message message)
        {

        }

        public void onVectorExpandMapHide(android.os.Message message)
        {

        }

        public void onAssistInfoHide(android.os.Message message)
        {

        }

        public void onRGSyncOperation(android.os.Message message)
        {

        }

        public void onCurRoadNameUpdate(android.os.Message message)
        {
