...
//	}
	...
	public SwipeItemLayout getCurrentOpenItem(){
		SwipeItemLayout swipeItem = null;
		View v;
		int i = 0;
	...
	public boolean closeIfMenuOpen(){
		SwipeItemLayout swipeItem = getCurrentOpenItem();
		if(swipeItem != null){
			swipeItem.smoothCloseMenu();
			return true;
		}
		return false;
	}
